...
const storageKey = "stephen-peace-intimacy-homework";
...
function formatAnswers() {
  ...
  const lines = [
    "Stephen & Peace - Preparing for Intimacy & Final Reflection Homework",
    `Name: ${answers.name || ""}`,
...
function downloadAnswers() {
  ...
  link.href = url;
  link.download = `${name}-intimacy-final-reflection-homework.txt`;
  link.click();
