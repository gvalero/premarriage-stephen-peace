# Stephen & Peace Premarriage Homework Pages
...
Important privacy note: these pages do not send responses anywhere by themselves.
GitHub Pages is static and has no private form backend. Each form stores answers in
...
2. Copy the contents of this `github-page` folder into the repository root.
